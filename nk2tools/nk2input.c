				  ...
				  4 ) == 0 )
			{
				...
				else if( string_length == 10 )
				{
					if( system_string_compare(
					     ...
					     1 ) == 0 )
					{
						*ascii_codepage = LIBNK2_CODEPAGE_ISO_8859_1;
						result          = 1;
					}
					else if( system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  1 ) == 0 )
					{
						*ascii_codepage = LIBNK2_CODEPAGE_ISO_8859_2;
						result          = 1;
					}
					else if( system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  1 ) == 0 )
					{
						*ascii_codepage = LIBNK2_CODEPAGE_ISO_8859_3;
						result          = 1;
					}
					else if( system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  1 ) == 0 )
					{
						*ascii_codepage = LIBNK2_CODEPAGE_ISO_8859_4;
						result          = 1;
					}
					else if( system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  1 ) == 0 )
					{
						*ascii_codepage = LIBNK2_CODEPAGE_ISO_8859_5;
						result          = 1;
					}
					else if( system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  1 ) == 0 )
					{
						*ascii_codepage = LIBNK2_CODEPAGE_ISO_8859_6;
						result          = 1;
					}
					else if( system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  1 ) == 0 )
					{
						*ascii_codepage = LIBNK2_CODEPAGE_ISO_8859_7;
						result          = 1;
					}
					else if( system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  1 ) == 0 )
					{
						*ascii_codepage = LIBNK2_CODEPAGE_ISO_8859_8;
						result          = 1;
					}
					else if( system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  1 ) == 0 )
					{
						*ascii_codepage = LIBNK2_CODEPAGE_ISO_8859_9;
						result          = 1;
					}
				}
				else if( string_length == 11 )
				{
					if( system_string_compare(
					     ...
					     2 ) == 0 )
					{
						*ascii_codepage = LIBNK2_CODEPAGE_ISO_8859_10;
						result          = 1;
					}
					else if( system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  2 ) == 0 )
					{
						*ascii_codepage = LIBNK2_CODEPAGE_ISO_8859_11;
						result          = 1;
					}
					else if( system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  2 ) == 0 )
					{
						*ascii_codepage = LIBNK2_CODEPAGE_ISO_8859_13;
						result          = 1;
					}
					else if( system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  2 ) == 0 )
					{
						*ascii_codepage = LIBNK2_CODEPAGE_ISO_8859_14;
						result          = 1;
					}
					else if( system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  2 ) == 0 )
					{
						*ascii_codepage = LIBNK2_CODEPAGE_ISO_8859_15;
						result          = 1;
					}
					else if( system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  2 ) == 0 )
					{
						*ascii_codepage = LIBNK2_CODEPAGE_ISO_8859_16;
						result          = 1;
					}
				}
			}
