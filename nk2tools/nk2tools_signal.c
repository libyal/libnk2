...
void (*nk2tools_signal_signal_handler)( nk2tools_signal_t ) = NULL;

/* Signal handler for Ctrl+C or Ctrl+Break signals
 */
BOOL WINAPI nk2tools_signal_handler(
             nk2tools_signal_t signal )
{
	static char *function = "nk2tools_signal_handler";
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( nk2tools_signal_signal_handler != NULL )
			{
				nk2tools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
 ...
 */
void nk2tools_signal_initialize_memory_debug(
      void )
{
	int flag = 0;
 ...
 */
int nk2tools_signal_attach(
     void (*signal_handler)( nk2tools_signal_t ),
     libcerror_error_t **error )
{
	static char *function = "nk2tools_signal_attach";
	...
	nk2tools_signal_signal_handler = signal_handler;

	if( SetConsoleCtrlHandler(
	     (PHANDLER_ROUTINE) nk2tools_signal_handler,
	     TRUE ) == 0 )
	{
		libcerror_error_set(
		 error,
...
#if defined( _MSC_VER )
	nk2tools_signal_initialize_memory_debug();
#endif
 ...
 * Returns 1 if successful or -1 on error
 */
int nk2tools_signal_detach(
     libcerror_error_t **error )
{
	static char *function = "nk2tools_signal_detach";
	...
	nk2tools_signal_signal_handler = NULL;
