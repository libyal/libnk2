...
#if !defined( _NK2TOOLS_GETOPT_H )
#define _NK2TOOLS_GETOPT_H
...
typedef struct nk2tools_option nk2tools_option_t;

struct nk2tools_option
{
...
#define nk2tools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t nk2tools_getopt(
                  int argument_count,
...
void nk2tools_getopt_wrapped_fprint(
      FILE *stream,
...
void nk2tools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const nk2tools_option_t *options,
      int number_of_options );

int nk2tools_getopt_get_options_string(
     const nk2tools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _NK2TOOLS_GETOPT_H ) */
