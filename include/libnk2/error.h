...
enum LIBNK2_ARGUMENT_ERROR
{
	 ...
	 */
	LIBNK2_ARGUMENT_ERROR_VALUE_OUT_OF_RANGE     = 7,
...
enum LIBNK2_COMPRESSION_ERROR
{
	 ...
	 */
	LIBNK2_COMPRESSION_ERROR_UNCOMPRESS_FAILED   = 2
};
...
enum LIBNK2_INPUT_ERROR
{
	 ...
	 */
	LIBNK2_INPUT_ERROR_CRC_MISMATCH              = 3,
	 ...
	 */
	LIBNK2_INPUT_ERROR_MISSING_LAST_SEGMENT_FILE = 5,

	/* The last section is missing from the input
	 */
	LIBNK2_INPUT_ERROR_MISSING_LAST_SECTION      = 6
};
...
enum LIBNK2_RUNTIME_ERROR
{
	 ...
	 */
	LIBNK2_RUNTIME_ERROR_VALUE_OUT_OF_RANGE      = 12,
