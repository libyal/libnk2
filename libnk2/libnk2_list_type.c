 ...
 */
int libnk2_list_element_initialize(
     libnk2_list_element_t **list_element,
     liberror_error_t **error )
{
	static char *function = "libnk2_list_element_initialize";
	...
	if( *list_element == NULL )
	{
		*list_element = (libnk2_list_element_t *) memory_allocate(
 ...
 * Returns 1 if successful or -1 on error
 */
int libnk2_list_element_free(
     libnk2_list_element_t **list_element,
     int (*value_free_function)( intptr_t *value, liberror_error_t **error ),
     liberror_error_t **error )
{
	static char *function = "libnk2_list_element_free";
	int result            = 1;
...
int libnk2_list_initialize(
     ...
     liberror_error_t **error )
{
	static char *function = "libnk2_list_initialize";
	...
	if( *list == NULL )
	{
		*list = (libnk2_list_t *) memory_allocate(
...
int libnk2_list_free(
     ...
     liberror_error_t **error )
{
	static char *function = "libnk2_list_free";
	int result            = 0;
     ...
     liberror_error_t **error )
{
	...
	static char *function               = "libnk2_list_empty";
...
int libnk2_list_clone(
     ...
     liberror_error_t **error )
{
	libnk2_list_element_t *source_list_element = NULL;
	intptr_t *destination_value                = NULL;
	static char *function                      = "libnk2_list_clone";
	int iterator                               = 0;
	...
	{
		*destination = (libnk2_list_t *) memory_allocate(
		                                  sizeof( libnk2_list_t ) );
...
int libnk2_list_get_amount_of_elements(
     ...
     liberror_error_t **error )
{
	static char *function = "libnk2_list_get_amount_of_elements";
...
{
	libnk2_list_element_t *list_element = NULL;
	static char *function               = "libnk2_list_get_element";
	int iterator                        = 0;
...
{
	libnk2_list_element_t *list_element = NULL;
	static char *function               = "libnk2_list_get_value";
	int result                          = 0;
	...
	result = libnk2_list_get_element(
	          list,
	          element_index,
	          &list_element,
	          error );
...
int libnk2_list_prepend_element(
     ...
     liberror_error_t **error )
{
	static char *function = "libnk2_list_prepend_element";
...
int libnk2_list_prepend_value(
     ...
     liberror_error_t **error )
{
	libnk2_list_element_t *element = NULL;
	static char *function          = "libnk2_list_prepend_value";
	...
	element = (libnk2_list_element_t *) memory_allocate(
	                                     sizeof( libnk2_list_element_t ) );
	...
	if( libnk2_list_prepend_element(
	     list,
	     element,
	     error ) != 1 )
	{
...
int libnk2_list_append_element(
     ...
     liberror_error_t **error )
{
	static char *function = "libnk2_list_append_element";
...
{
	libnk2_list_element_t *element = NULL;
	static char *function          = "libnk2_list_append_value";
...
{
	libnk2_list_element_t *list_element = NULL;
	static char *function               = "libnk2_list_insert_element";
	int result                          = 0;
	int iterator                        = 0;
	...
	else
	{
		     ...
		     iterator++ )
		{
			...
			else if( result == LIBNK2_LIST_COMPARE_EQUAL )
			{
				return( 0 );
			}
			else if( result == LIBNK2_LIST_COMPARE_LESS )
			{
...
{
	libnk2_list_element_t *element = NULL;
	static char *function          = "libnk2_list_insert_value";
	int result                     = 0;
	...
	result = libnk2_list_insert_element(
	          list,
	          element,
...
int libnk2_list_remove_element(
     ...
     liberror_error_t **error )
{
	static char *function = "libnk2_list_remove_element";
