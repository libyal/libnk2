...
#if !defined( _LIBNK2_SYSTEM_STRING_H )
#define _LIBNK2_SYSTEM_STRING_H
...
#define LIBNK2_WIDE_SYSTEM_CHARACTER_TYPE
#endif

#if defined( LIBNK2_WIDE_SYSTEM_CHARACTER_TYPE )

typedef wchar_t libnk2_system_character_t;

#define PRIc_LIBNK2_SYSTEM	"lc"
#define PRIs_LIBNK2_SYSTEM	"ls"

/* Intermediate version of the macro required
 * for correct evaluation predefined string
 */
#define _LIBNK2_SYSTEM_STRING_INTERMEDIATE( string ) \
	L ## string

#define _LIBNK2_SYSTEM_STRING( string ) \
	_LIBNK2_SYSTEM_STRING_INTERMEDIATE( string )

#define libnk2_system_string_copy( destination, source, size ) \
	wide_string_copy( destination, source, size )

#define libnk2_system_string_length( string ) \
 ...
 */
#define libnk2_system_string_size_from_narrow_string( narrow_string, narrow_string_size, system_string_size, error ) \
	libuna_utf32_string_size_from_utf8( (libuna_utf8_character_t *) narrow_string, narrow_string_size, system_string_size, error )

#define libnk2_system_string_copy_from_narrow_string( system_string, system_string_size, narrow_string, narrow_string_size, error ) \
...
#define narrow_string_size_from_libnk2_system_string( system_string, system_string_size, narrow_string_size, error ) \
	libuna_utf8_string_size_from_utf32( (libuna_utf32_character_t *) system_string, system_string_size, narrow_string_size, error )

#define narrow_string_copy_from_libnk2_system_string( narrow_string, narrow_string_size, system_string, system_string_size, error ) \
...
typedef char libnk2_system_character_t;

#define PRIc_LIBNK2_SYSTEM	"c"
#define PRIs_LIBNK2_SYSTEM	"s"
 ...
 */
#define libnk2_system_string_size_from_wide_string( wide_string, wide_string_size, system_string_size, error ) \
	libuna_utf8_string_size_from_utf32( (libuna_utf32_character_t *) wide_string, wide_string_size, system_string_size, error )

#define libnk2_system_string_copy_from_wide_string( system_string, system_string_size, wide_string, wide_string_size, error ) \
...
#define wide_string_size_from_libnk2_system_string( system_string, system_string_size, wide_string_size, error ) \
	libuna_utf32_string_size_from_utf8( (libuna_utf8_character_t *) system_string, system_string_size, wide_string_size, error )

#define wide_string_copy_from_libnk2_system_string( wide_string, wide_string_size, system_string, system_string_size, error ) \
...
/* wide string conversion functions
 */
#define libnk2_system_string_size_from_wide_string( wide_string, wide_string_size, string_size, error ) \
