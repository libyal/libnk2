...
#if !defined( _LIBNK2_INTERNAL_EXTERN_H )
#define _LIBNK2_INTERNAL_EXTERN_H

#include <common.h>

#if !defined( __CYGWIN__ ) && !defined( _WIN32 ) && defined( __has_attribute )
#if __has_attribute( visibility )
#define LIBNK2_INTERNAL	__attribute__((visibility("hidden"))) extern

#else
#define LIBNK2_INTERNAL	extern
...
#define LIBNK2_EXTERN_VARIABLE	LIBNK2_INTERNAL
