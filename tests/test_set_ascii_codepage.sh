...
NK2_TEST_SET_ASCII_CODEPAGE="nk2_test_set_ascii_codepage";

if ! test -x ${NK2_TEST_SET_ASCII_CODEPAGE};
then
	NK2_TEST_SET_ASCII_CODEPAGE="nk2_test_set_ascii_codepage.exe";
fi

if ! test -x ${NK2_TEST_SET_ASCII_CODEPAGE};
then
	echo "Missing executable: ${NK2_TEST_SET_ASCII_CODEPAGE}";
...
do
	...
	${TEST_RUNNER} ./${NK2_TEST_SET_ASCII_CODEPAGE} ${CODEPAGE};
