...
#if !defined( _NK2_TEST_GETOPT_H )
#define _NK2_TEST_GETOPT_H
...
#define nk2_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t nk2_test_getopt(
                  int argument_count,
...
#endif /* !defined( _NK2_TEST_GETOPT_H ) */
