...
def pynk2_test_single_open_close_file(filename, mode):
...
def pynk2_test_multi_open_close_file(filename, mode):
...
def pynk2_test_single_open_close_file_object(filename, mode):
  ...
  try:
    ...
    nk2_file.open_file_object(file_object, mode)
    nk2_file.close()
...
def pynk2_test_single_open_close_file_object_with_dereference(
    filename, mode):
...
def pynk2_test_multi_open_close_file_object(filename, mode):
...
def main():
  ...
  if not pynk2_test_single_open_close_file(options.source, "r"):
    return False

  if not pynk2_test_single_open_close_file(None, "r"):
    return False

  if not pynk2_test_single_open_close_file(options.source, "w"):
    return False

  if not pynk2_test_multi_open_close_file(options.source, "r"):
    return False

  if not pynk2_test_single_open_close_file_object(options.source, "r"):
    return False

  if not pynk2_test_single_open_close_file_object_with_dereference(
      options.source, "r"):
    return False

  if not pynk2_test_multi_open_close_file_object(
      options.source, "r"):
    return False
